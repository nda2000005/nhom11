            ...
            <div class="flex flex-col gap-6">
                ...
                <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        ...
                        <a href="../orders/index.php" class="flex flex-col items-center justify-center p-4 bg-purple-50/50 hover:bg-purple-50 rounded-xl border border-purple-100/50 transition text-center group">
                        ...
                        <a href="../reports/financial.php" class="flex flex-col items-center justify-center p-4 bg-orange-50/50 hover:bg-orange-50 rounded-xl border border-orange-100/50 transition text-center group">
